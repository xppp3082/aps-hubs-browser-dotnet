...
public partial class APS
{
    ...
    public async Task<IEnumerable<TopFolderData>> GetTopFolders(
        string hubId,
        string projectId,
        Tokens tokens
    )
    ...
    public async Task<IEnumerable<IFolderContentsData>> GetFolderContents(
        string projectId,
        string folderId,
        Tokens tokens
    )
    ...
    {
        var dataManagementClient = new DataManagementClient();
        var versions = await dataManagementClient.GetItemVersionsAsync(
            projectId,
            itemId,
            accessToken: tokens.InternalToken
        );
    ...
    public async Task<VersionData> GetTipVersion(string projectId, string itemId, Tokens tokens)
    {
        var dataManagementClient = new DataManagementClient();
        ItemTip itemTip = await dataManagementClient.GetItemTipAsync(
            projectId,
            itemId,
            null,
            accessToken: tokens.InternalToken,
